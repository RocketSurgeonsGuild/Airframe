...
namespace Rocket.Surgery.ReactiveUI
{
    ...
    public static class AlertViews
    {
        ...
        /// <param name="duration">The duration to display the toast.</param>
        /// <param name="position">The position for the toast to display.</param>
        public static void ShowToast(string title, string message, ToastAppearance appearance, double duration = 2.0, ToastPosition position = ToastPosition.Center)
        {
            Toast
                .MakeToast(message)
                .SetTitle(title)
        ...
        /// <param name="duration">The duration to display the toast.</param>
        /// <param name="position">The position for the toast to display.</param>
        public static void ShowToast(string title, string message, Func<ToastAppearance> appearance, double duration = 2.0, ToastPosition position = ToastPosition.Center)
        {
            Toast
                .MakeToast(message)
                .SetTitle(title)
