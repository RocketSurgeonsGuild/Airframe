...
/// without a body: an interface member with no default implementation, or a member marked
/// <c>abstract</c> in an abstract class. A default interface member, a static interface member,
/// and a concrete member of an abstract class are all excluded, since none of them is part of the
/// contract an implementer has to fulfil sight unseen.
/// </remarks>
