...
internal static class LocationEventExtensions
{
    ...
    public static AuthorizationChangedEvent ToNotification(this CLAuthorizationChangedEventArgs args) => new(AuthorizationStatuses[args.Status]);
    ...
    /// <param name="args">The arguments.</param>
    /// <returns>The changed notification.</returns>
    public static HeadingUpdatedEvent ToNotification(this CLHeadingUpdatedEventArgs args) => new();
    ...
    /// <param name="args">The arguments.</param>
    /// <returns>The notification.</returns>
    public static LocationUpdatedEvent ToNotification(this CLLocationUpdatedEventArgs args) => new(
    ...
    /// <param name="args">The arguments.</param>
    /// <returns>The notification.</returns>
    public static RegionChangedEvent ToNotification(this CLRegionEventArgs args) => new(args.Region.ToGeoRegion());
    ...
    /// <param name="args">The arguments.</param>
    /// <returns>The notification.</returns>
    public static RegionChangedEvent ToNotification(this CLRegionStateDeterminedEventArgs args) => new(args.Region.ToGeoRegion(), RegionStates[args.State]);
    ...
    /// <param name="args">The arguments.</param>
    /// <returns>The notification.</returns>
    public static ErrorEvent ToNotification(this NSErrorEventArgs args) => new(new Exception(args.ToString()));
    ...
    /// <param name="args">The arguments.</param>
    /// <returns>The notification.</returns>
    public static VisitedEvent ToNotification(this CLVisitedEventArgs args) => new(
        args.Visit.Coordinate.ToLocation(),
        args.Visit.ArrivalDate.ToLocalTime(),
        args.Visit.DepartureDate.ToLocalTime(),
        args.Visit.HorizontalAccuracy);
    ...
    /// <param name="args">The arguments.</param>
    /// <returns>The notification.</returns>
    public static RegionErrorEvent ToNotification(this CLRegionErrorEventArgs args) => new(new Exception(args.Error.ToString()), ToGeoRegion(args.Region));
    ...
    /// <summary>
    /// Converts the <see cref="CLLocationCoordinate2D"/> to a <see cref="GeoCoordinate"/>.
    /// </summary>
    ...
    public static IGpsLocation ToGpsLocation(this CLLocation location) => new GpsLocation(
        ...
        0,
        location.Timestamp.ToLocalTime());

    public static DateTime ToLocalTime(this NSDate nsDate)
    {
        var referenceDate = TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(2001, 1, 1, 0, 0, 0));
